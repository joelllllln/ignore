...
(() => {
  ...
  function mineAccrue(sec, quiet) {   // fractional progress buffers in META.asc.mineBuf; whole cores land in the bank
    ...
    if (!quiet) showCorePop(whole, "dug by your ⛏ ◈ core mines");
    return whole;
  }
  ...
  function render() {
    ...
    if (state === "play" && comboMul > 1.02 && !planetMeta(S.galaxy).conquered) {
