...
(() => {
  ...
  const WARDENS = [null,
    ...
    { n: "ARC SHRIKE",         tell: "jukes constantly — your finger tracks it better than turrets", dur: 1.45, add: 7, kit: { zig: 1 } },
    { n: "SLAG BROODMOTHER",   tell: "floods the pit with brood — clear the adds or drown",    dur: 1.35, add: 0,      kit: { spawner: 1 } },   // brood IS its kit: no separate escort waves on top
  ...
  function spawnBoss(warden) {
    ...
    const d = { x: W / 2, y: H * 0.44, vx: rnd(-18, 18), vy: rnd(-8, 8), hp, maxHp: hp, value: val, value0: val,   // v18.11: anchor at midfield — the patrol personalities orbit THIS point, and H*0.3 kept bosses hugging the top out of easy reach
