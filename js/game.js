...
(() => {
  ...
  const REVEALS = [
    ...
    { k: "ascend",  when: () => pendingCores() >= 1,
      tip: "You have ◈ CORES pending. Ascending resets the run and makes every future run permanently faster." },
  ];
  ...
  function ascHeroHtml(pend) {
    ...
    return '<div class="ax-hero ' + v.kind + '">'
      + '<span class="ax-k">' + (pend < 1 ? "NOTHING BANKED" : "YOU BANK") + '</span>'
