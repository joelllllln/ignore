...
(() => {
  ...
  const REVEALS = [
    ...
    { k: "eco",     when: () => S.units.length >= 3 || treeNodeCount() > 0,
      tip: "The ECONOMY tab multiplies what every dot is worth — the backbone of your income." },
