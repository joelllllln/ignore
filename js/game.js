...
(() => {
  ...
  function syncHUD() {
    ...
    { const setVis = (el, on) => { if (el && (el.style.display === "none") === on) el.style.display = on ? "" : "none"; };
      ...
      setVis($("abilities"), revealed("abil") && !settleShown && navAt === "play");   // v18.62: one owner — see the settle block below
