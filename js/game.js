...
(() => {
  ...
  function useAbility(k) {
    ...
    if (k === "dotrain" && planetMeta(S.galaxy).conquered) { Audio_err(); return; }   // v18.8: no storms over settled worlds — and no cooldown burned on the refusal
