...
(() => {
  ...
  function Audio_saber(x, y) {
    ...
    if (!Saber.g) {   // ignite
      ...
      const g = a.createGain(); g.gain.setValueAtTime(0.0001, t0); g.gain.setTargetAtTime(0.055, t0, 0.03);
      const fil = a.createBiquadFilter(); fil.type = "lowpass"; fil.Q.value = 5; fil.frequency.value = 150;
      const o1 = a.createOscillator(); o1.type = "sawtooth"; o1.frequency.value = 55;
      const o2 = a.createOscillator(); o2.type = "sawtooth"; o2.frequency.value = 55; o2.detune.value = 9;
      const sub = a.createOscillator(); sub.type = "sine"; sub.frequency.value = 27.5;
    ...
    Saber.fil.frequency.setTargetAtTime(150 + k * 1050 + flip * 480, t, flip > 0.4 ? 0.02 : 0.05);   // voom stays DARK — capped ~1.7kHz even flat-out
    Saber.g.gain.setTargetAtTime(0.055 + k * 0.075 + flip * 0.02, t, (k > 0.25 || flip > 0.4) ? 0.028 : 0.12);
