...
(() => {
  ...
  const conq0Hide = () => !!document.querySelector('.modal.show') || !!document.querySelector('#tutorial.show');
  function syncHUD() {
    coachTick(1 / 60);
    ...
    { const setVis = (el, on) => { if (el && (el.style.display === "none") === on) el.style.display = on ? "" : "none"; };
      ...
      setVis($("abilities"), revealed("abil"));
  ...
  const TUT_STEPS = [
    ...
    { sel: "#up-list", t: "Buy a defender", x: "More guns, more kills, more cash. The line above the shop always tells you <b>what to do next</b> — follow it and the rest of the game opens up as you go." },
  ];
  const Tut = {
    i: 0,
