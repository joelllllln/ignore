...
(() => {
  ...
  function coachTick(dt) {
    ...
    const busy = state !== "play" || document.querySelector(".modal.show") || document.querySelector("#tutorial.show");
  ...
  const conq0Hide = () => !!document.querySelector('.modal.show') || settleShown;
  function syncHUD() {
    coachTick(1 / 60);
  ...
  const TUT_STEPS = [
    { sel: "#game", t: "Drag to shoot", x: "<b>Drag across the field</b> — go on, try it now. Your defenders also fire on their own, and <b>killing dots is your entire economy</b>." },
