...
(() => {
  ...
  function travelDur(a) {
    // v17.22 (owner call: "remove time to travel between planets"): the transit wait is GONE.
    // 2 seconds — just enough for the launch rumble → arrival cinematic handoff to read as a jump,
    // not a teleport glitch. (The launch COST — the income-anchored save — is the whole gate now;
    // the pay-to-skip button still exists but a 2s hop makes it a no-op.)
    return 2;
  }
