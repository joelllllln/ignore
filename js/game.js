...
(() => {
  ...
  const conq0Hide = () => !!qs('.modal.show') || settleShown;
  function syncHUD() {
    coachTick(1 / 60);
    ...
    if (S.travel) { enroute = true; label = "⟶ IN WARP…"; dis = true; }   // v17.29: travel is a 7s cinematic — pay-to-skip removed (there is nothing to skip)
      ...
      else { const e = wallEtaH();   // v18.60: "CONQUER 0%" is a fact; "CONQUER 0% · ~8m" is a goal
  ...
  const TUT_STEPS = [
    ...
    { sel: '#nav .nv[data-nav="upgrades"]', t: "Everything you buy", x: "Defenders, collectors and economy all live in <b>UPGRADES</b>. Whenever you are unsure, the game keeps <b>one instruction</b> on screen — just follow it." },
  ];
  const Tut = {
    i: 0,
