...
(() => {
  ...
  function update(dt) {
    ...
    for (const d of dots) {
      ...
      if (blackholeT > 0) { const dx = W / 2 - d.x, dy = H / 2 - d.y, dl = Math.hypot(dx, dy) || 1; d.x += dx / dl * 220 * dt; d.y += dy / dl * 220 * dt; }   // v18.74: PULL ONLY — no direct damage, ever
