...
(() => {
  ...
  function render() {
    ...
    if (state === "play" && !S.travel && planetMeta(S.galaxy).conquered && !wardenOn && conqCardT <= 0) {
      ...
      const body = [
        "this world pays no credits — the frontier is where the money is",   // v18.79
        ...
        "launch ⟶ the next frontier whenever you like — it is free",
      ];
