  ...
  function renderSettings() {
    ...
    ub.onclick = () => { vibe(10); ub.disabled = true; ub.textContent = "CHECKING…";
      checkForUpdate(true, res => {
        if (res && res.indexOf("newer:") === 0) { ub.textContent = "⬆ v" + res.slice(6) + " — UPDATING…"; save(); setTimeout(() => location.reload(), 350); return; }
